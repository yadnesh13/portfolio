      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-10">
          ...
          {projects.map((project, index) => (
            <Reveal key={index}>
              <div className="border border-gray-900 rounded-3xl p-8 hover:border-gray-700 hover:-translate-y-1 transition-all duration-300 hover:scale-105">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <a
                    ...
                    className="border border-gray-700 px-6 py-3 rounded-xl hover:border-white hover:text-white transition-all duration-300 hover:scale-105 text-center"
                  >
                    View Project
                  </a>
